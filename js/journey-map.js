...
(function () {
  ...
  var LESSONS = [
    ...
    {n:7, realm:'fire', stage:1, title:'The Database Depths', technique:'Emberdraw', insight:'Use database caches first', impact:'Avoids unnecessary cache layers', learned:'Databases reuse data pages and query plans. Indexes also help reduce query work.', helped:'You can tune existing heat before adding another copy to the system.', from:[5,6], to:[13,14]},
    ...
    {n:12, realm:'war', stage:3, title:'The Latency Lord’s Attacks', technique:'The Trial', insight:'Defend cache failure modes', impact:'Turns prior lessons into resilience', learned:'Defend against five cache attacks and learn how Bloom filters reject many nonexistent IDs.', helped:'Combine keys, TTL, single-flight and replication with negative caching and a current Bloom filter.', from:[2,3,4,6,8,10,11], to:[13,14]},
